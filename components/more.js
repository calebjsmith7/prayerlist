...
export default More = () => {
    return(
        ...
        <View style={styles.container}>
            <Text style={{color: '#1e2427', fontSize: 30, textDecorationLine: 'underline', marginTop: '7%', marginLeft: '5%'}}>Love this app?</Text>
            <Text style={{color: '#1e2427', fontSize: 21, marginTop: '4%', marginLeft: '5%', marginRight: '5%'}}>Leave us a review! If you have any comments, questions, or concerns, email our support!</Text>
